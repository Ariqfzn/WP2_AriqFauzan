<section>
    ...
    <p align='justify'>Controller merupakan kumpulan instruksi aksi yang
        ...
        model secara langsung, intinya data yang tersimpan di database
    ...
    <p align='justify'>Dari penjelasan tentang model view dan controller
        ...
        mendesign tampilan aplikasi, karena back-end developer yang menangani
        bagian controller dan modelnya. Jadi pembagian tugas pun menjadi mudah
        dan pengembangan aplikasi dapat dilakukan dengan cepat dan terstruktur.</p>
</section>            